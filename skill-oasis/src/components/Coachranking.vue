<template>
  <div class="row">
    <div class="mx-1" style="background-color: #eceeec">
      <div class="row mt-3">
        <div
          class="card gx-0"
        ...
        >
          ...
          <div class="card-body row">
            <div class="col-12">
              ...
              <a v-if="lesson.rate != 0" style="opacity: 0.6">
                {{ lesson.rate }}
              </a>
              <a v-if="lesson.rate != 0" style="opacity: 0.6">
                ({{ lesson.review }}件)
              </a>
              <a v-if="lesson.rate == 0" style="opacity: 0.6"> - </a>
            </div>
